import { Extension, attrsEqual, callOrReturn, commands, decodeHtmlEntities, encodeHtmlEntities, flattenExtensions, generateJSON, getExtensionField, getSchema, marksEqual, sortExtensions } from "@tiptap/core";
...
var MarkdownManager = class {
	...
	*/
	constructor(options) {
		...
		this.markedInstance = (_options$marked = options === null || options === void 0 ? void 0 : options.marked) !== null && _options$marked !== void 0 ? _options$marked : marked;
	...
	addCommands() {
		return {
			setContent: (content, options) => {
				if (!(options === null || options === void 0 ? void 0 : options.contentType)) return commands.setContent(content, options);
				if (assumeContentType(content, options === null || options === void 0 ? void 0 : options.contentType) !== "markdown" || !this.editor.markdown) return commands.setContent(content, options);
			...
			insertContent: (value, options) => {
				if (!(options === null || options === void 0 ? void 0 : options.contentType)) return commands.insertContent(value, options);
				if (assumeContentType(value, options === null || options === void 0 ? void 0 : options.contentType) !== "markdown" || !this.editor.markdown) return commands.insertContent(value, options);
			...
			insertContentAt: (position, value, options) => {
				if (!(options === null || options === void 0 ? void 0 : options.contentType)) return commands.insertContentAt(position, value, options);
				if (assumeContentType(value, options === null || options === void 0 ? void 0 : options.contentType) !== "markdown" || !this.editor.markdown) return commands.insertContentAt(position, value, options);
				const mdContent = this.editor.markdown.parse(value);
...
//#endregion
export { Markdown, MarkdownManager, assumeContentType, closeMarksBeforeNode, extractAbsorbedBlankLines, findMarksToClose, findMarksToCloseAtEnd, findMarksToOpen, isTaskItem, reopenMarksAfterNode, wrapInMarkdownBlock };
